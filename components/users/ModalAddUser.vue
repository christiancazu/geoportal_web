<template>
  <BaseModal title="Registrar nuevo usuario" name-state="modalAddUser" :show-modal="modalAddUser">
    <template v-slot:content>
      ...
      >
        <el-row :gutter="10" align="bottom" justify="center">
          ...
          <el-col :md="12">
            ...
            <el-form-item label="Correo Electrónico" prop="email">
              <el-input v-model="form.email" type="text" auto-complete="off" />
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row :gutter="10">
          ...
          <el-col :xs="12" :sm="12" :md="12">
            <el-form-item class="pl-4" label="Privilegio">
              <el-switch
    ...
    <template v-slot:actions>
      <el-button
        ...
        size="small"
        :disabled="processingForm"
        @click="$_modalVisibilityMixin_close('modalAddUser')"
      >CANCELAR</el-button>
      <el-button
        class="ma-2"
        size="small"
...
export default {
  ...
  watch: {
    modalAddUser: function(newState, oldState) {
      if (!newState) {
  ...
  computed: {
    ...mapState({
      ...
      modalAddUser: state => state.modalsVisibilities.modalAddUser
    })
  },
      ...
      this.$refs.form.validate(valid => {
        if (valid) {
          ...
          this.createUser().then(response => {
            this.$_modalVisibilityMixin_close("modalAddUser");
